from .IRLQUIC import iRL1_simplified, iRL1_scad, iRL1_mcp
...
def diir_quic(
    ...
    X, _, KKT_list, time_list = iRL1_simplified(S, mu, eps0, X0, rho, p, MaxIter, tolerance, alpha, None, msg)

    return X, KKT_list, time_list
